...
Sri Lanka Election Commission warns media: No official results published if guidelines violated. Chairman RMAL Ratnayake emphasizes compliance with media guidelines. Violations may result in withholding official election data.
...
When asked about the actions taken against any media company that violates media guidelines, the chairman said he would warn not to violate the guidelines first.

"If any media company violates the media guidelines that we have published again, we will consider that the official election results will not be released," Ratnayake said.

...

[Data](articles/c181a5b2.json)

[Extended Data](ext_articles/c181a5b2.ext.json)
...
International Election Monitors meet Sri Lanka Election Commission today. First joint meeting includes Asian Network for Free Elections. PAFFREL urges maintaining law and order during final week of presidential election.
...
Executive Director of the Division Rohana Hettiarachchi said that the people should not be inactive regarding certain matters.

◼️

[Data](articles/09af08a1.json)

[Extended Data](ext_articles/09af08a1.ext.json)
...
Weather alert: Rainfall, thunderstorms, heavy winds forecasted for several provinces and coastal areas. Strong gusts and lightning possible. Public advised to exercise caution.
...
[Extended Data](ext_articles/37aff360.ext.json)
...
[Extended Data](ext_articles/8b0eb5ee.ext.json)
...
[Extended Data](ext_articles/24fcfeb1.ext.json)
...
Police warn against sharing airport videos on social media, calling it misinformation. They request public cooperation to prevent spreading false content, threatening legal action if necessary.
...
If the videos of videos are posted as such a national security, the police said that steps will be taken to act legally against such ones.

◼️

[Data](articles/f1dc62d5.json)

[Extended Data](ext_articles/f1dc62d5.ext.json)
...
Elections Commission uses cardbot boxes for presidential election. Ballot boxes distributed to officers on 20th. Cardboard boxes chosen over wooden ones due to ballot paper size. All election matters completed. Officers notified to prepare for duties.
...
[Extended Data](ext_articles/ca20dfc6.ext.json)

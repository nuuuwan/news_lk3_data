...
*2024-06-17 23:38:00* · [`virakesarilk`](https://www.virakesari.lk/article/186316) · `ta`

Durairasa Ravikaran criticizes the government's failure to improve bridges in Tamil areas, highlighting the urgent need for repairs, especially at the over 70-year-old Vattuvagal Bridge crucial for Mullaitivu's traffic. He questions the government's ability to address Tamil issues when basic infrastructure needs are neglected.
...
The remaining people from the Mullivaikkal genocide during the final period were out of the Vadavuwal Bridge. The Vadduvagal Bridge is the most important bridge among the Tamil people here.

...

[Data](articles/5db97cdb.json)

[Extended Data](ext_articles/5db97cdb.ext.json)

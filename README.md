...
Plantation companies must comply with the government's gazette on salary hikes for workers. Minister Jeevan Thondaman criticizes the current pay system, suggesting a transition that will take four years. He disputes claims by opposition parties about empowering plantation workers and notes that companies, initially resistant to salary increases, have now agreed to a 200 rupee hike after the government's notification.
...
It will claim that each party gets each amount during the election period. Although the opposition parties claim to turn the plantation people into small -scale owners, it is questionable for the mechanism.

...

[Data](articles/7551d4d8.json)

[Extended Data](ext_articles/7551d4d8.ext.json)

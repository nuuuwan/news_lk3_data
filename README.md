...
In Iran's presidential election, Saeed Jallee and Masood Bessecian are locked in a close race, each securing around 40% of over eight million votes. A second round is imminent if neither reaches 50%, set for this Friday, following the election triggered by the death of former President Ibrahim Raisi.
...
[Extended Data](ext_articles/e4e53eb0.ext.json)
...
Son of former MP Palitha Range Bandara arrested over vehicle accident.
...
[Extended Data](ext_articles/8d050a7c.ext.json)
...
On July 2 and 3, Parliament will debate the implementation of foreign loans, including final loans from the Democratic Socialist Republic of Sri Lanka and others, as per a special statement by the President. This decision was made at a Committee meeting on June 28, with discussions focusing on contractual restructuring agreements. The debate aims to secure parliamentary approval for implementing these agreements.
...
The final loans of the Democratic Socialist Republic and the Democratic Socialist Republic of Sri Lanka (OCC) and the Communication Socialist Republic of Sri Lanka (OCC) and the Final Loans on 26.06.2012The proposal will be presented to Parliament to provide the necessary permission to implement the necessary permission to implement the agreement agreement.

◼️

[Data](articles/ced510d2.json)

[Extended Data](ext_articles/ced510d2.ext.json)
